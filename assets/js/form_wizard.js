...
var FormWizard = function() {
    ...
    var _componentWizard = function() {
        ...
        $('.steps-basic').steps({
            ...
            labels: {
                previous: '<i class="icon-arrow-left13 mr-2" /> Əvvəlki',
                next: 'Sonrakı <i class="icon-arrow-right14 ml-2" />',
                finish: 'Göndər <i class="icon-arrow-right14 ml-2" />'
            },
    ...
    var _componentUniform = function() {
        ...
        $('.form-input-styled').uniform({
            fileButtonClass: 'action btn btn-private',
            fileDefaultHtml: 'Heç bir fayl seçilməyib',
            fileButtonHtml:"Fayl seçin"
        });
    };
